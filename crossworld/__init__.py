"""The public-facing Crossworld API."""
...
import crossworld.envs.mujoco.env_dict as _env_dict
from crossworld.types import Task


class CrossWorldEnv(abc.ABC):
...
class MT1(Benchmark):
    """The MT1 benchmark. A goal-conditioned RL environment for a single Crossworld task."""
...
class ML1(Benchmark):
    """The ML1 benchmark. A meta-RL environment for a single Crossworld task. The train and test set contain different goal positions.
