...
class JacoDoorOpenV2Policy(Policy):
    @staticmethod
    @assert_fully_parsed
    ...
    def _desired_pos(o_d: dict[str, npt.NDArray[np.float64]]) -> npt.NDArray[Any]:
        ...
        # push from front edge toward door handle's centroid
            ...
            return pos_door + np.array([-0.06, -0.015, 0.0])
