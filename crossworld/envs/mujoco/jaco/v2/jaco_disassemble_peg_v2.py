...
from crossworld.types import InitConfigDict


class JacoNutDisassembleEnvV2(JacoEnv):
    ...
    def compute_reward(
        ...
        threshold = JacoNutDisassembleEnvV2.WRENCH_HANDLE_LENGTH / 2.0
        if abs(wrench[0] - hand[0]) < threshold:
            wrench_threshed[0] = hand[0]

        reward_quat = JacoNutDisassembleEnvV2._reward_quat(obs)
        ...
        reward_in_place = JacoNutDisassembleEnvV2._reward_pos(
