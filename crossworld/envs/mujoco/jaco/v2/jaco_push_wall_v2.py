...
class JacoPushWallEnvV2(JacoEnv):
    """JacoPushEnvV2 updates JacoReachPushPickPlaceWallEnv.

    Env now handles only 'Push' task type from JacoReachPushPickPlaceWallEnv.
    ...
    def model_name(self) -> str:
        return full_v2_path_for("jaco/jaco_push_wall_v2.xml")
