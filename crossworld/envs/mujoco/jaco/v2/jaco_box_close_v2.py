...
class JacoBoxCloseEnvV2(JacoEnv):
    def __init__(
        self,
    ...
    def model_name(self) -> str:
        return full_v2_path_for("jaco/jaco_box.xml")
    ...
    def compute_reward(
        ...
        reward_grab = JacoBoxCloseEnvV2._reward_grab_effort(actions)
        reward_quat = JacoBoxCloseEnvV2._reward_quat(obs)
        reward_steps = JacoBoxCloseEnvV2._reward_pos(obs, self._target_pos)
