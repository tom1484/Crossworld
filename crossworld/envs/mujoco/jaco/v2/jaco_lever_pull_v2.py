...
class JacoLeverPullEnvV2(JacoEnv):
    """JacoLeverPullEnv.
    ...
    def model_name(self) -> str:
        return full_v2_path_for("jaco/jaco_lever_pull.xml")
    ...
    def compute_reward(
        ...
        # De-emphasize y error so that we get Jaco's shoulder underneath the
        # lever prior to bumping on against
        scale = np.array([4.0, 1.0, 4.0])
        # Offset so that we get the Jaco's shoulder underneath the lever,
