...
from crossworld.types import HammerInitConfigDict


class JacoHammerEnvV2(JacoEnv):
    ...
    def model_name(self) -> str:
        return full_v2_path_for("jaco/jaco_hammer.xml")
    ...
    def compute_reward(
        ...
        threshold = JacoHammerEnvV2.HAMMER_HANDLE_LENGTH / 2.0
        if abs(hammer[0] - hand[0]) < threshold:
            hammer_threshed[0] = hand[0]

        reward_quat = JacoHammerEnvV2._reward_quat(obs)
        ...
        reward_in_place = JacoHammerEnvV2._reward_pos(hammer_head, self._target_pos)
