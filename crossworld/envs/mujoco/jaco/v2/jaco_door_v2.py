...
class JacoDoorEnvV2(JacoEnv):
    ...
    def model_name(self) -> str:
        return full_v2_path_for("jaco/jaco_door_pull.xml")
    ...
    def compute_reward(
        ...
        reward_grab = JacoDoorEnvV2._reward_grab_effort(actions)
        reward_steps = JacoDoorEnvV2._reward_pos(obs, theta)
