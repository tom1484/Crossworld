...
class PandaDoorEnvV2(PandaEnv):
    ...
    def model_name(self) -> str:
        return full_v2_path_for("panda/panda_door_pull.xml")
    ...
    def compute_reward(
        ...
        reward_grab = PandaDoorEnvV2._reward_grab_effort(actions)
        reward_steps = PandaDoorEnvV2._reward_pos(obs, theta)
