...
class PandaBinPickingEnvV2(PandaEnv):
    """PandaBinPickingEnv.

    Motivation for V2:
        V1 was often unsolvable because the cube could be located outside of
        the starting bin. It could even be near the base of the Panda and out
    ...
    def model_name(self) -> str:
        return full_v2_path_for("panda/panda_bin_picking.xml")
