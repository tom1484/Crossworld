...
class PandaBoxCloseEnvV2(PandaEnv):
    def __init__(
        self,
    ...
    def model_name(self) -> str:
        return full_v2_path_for("panda/panda_box.xml")
    ...
    def compute_reward(
        ...
        reward_grab = PandaBoxCloseEnvV2._reward_grab_effort(actions)
        reward_quat = PandaBoxCloseEnvV2._reward_quat(obs)
        reward_steps = PandaBoxCloseEnvV2._reward_pos(obs, self._target_pos)
