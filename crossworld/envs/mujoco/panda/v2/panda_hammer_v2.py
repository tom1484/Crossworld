...
class PandaHammerEnvV2(PandaEnv):
    ...
    def model_name(self) -> str:
        return full_v2_path_for("panda/panda_hammer.xml")
    ...
    def compute_reward(
        ...
        threshold = PandaHammerEnvV2.HAMMER_HANDLE_LENGTH / 2.0
        if abs(hammer[0] - hand[0]) < threshold:
            hammer_threshed[0] = hand[0]

        reward_quat = PandaHammerEnvV2._reward_quat(obs)
        ...
        reward_in_place = PandaHammerEnvV2._reward_pos(hammer_head, self._target_pos)
