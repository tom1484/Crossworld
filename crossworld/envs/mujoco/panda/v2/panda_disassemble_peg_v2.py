...
class PandaNutDisassembleEnvV2(PandaEnv):
    ...
    def compute_reward(
        ...
        threshold = PandaNutDisassembleEnvV2.WRENCH_HANDLE_LENGTH / 2.0
        if abs(wrench[0] - hand[0]) < threshold:
            wrench_threshed[0] = hand[0]

        reward_quat = PandaNutDisassembleEnvV2._reward_quat(obs)
        ...
        reward_in_place = PandaNutDisassembleEnvV2._reward_pos(
