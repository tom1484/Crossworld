...
class PandaPushWallEnvV2(PandaEnv):
    """PandaPushEnvV2 updates PandaReachPushPickPlaceWallEnv.

    Env now handles only 'Push' task type from PandaReachPushPickPlaceWallEnv.
    ...
    def model_name(self) -> str:
        return full_v2_path_for("panda/panda_push_wall_v2.xml")
